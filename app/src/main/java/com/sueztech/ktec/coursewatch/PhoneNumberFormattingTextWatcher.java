...
class PhoneNumberFormattingTextWatcher implements TextWatcher {
     ...
     */
    PhoneNumberFormattingTextWatcher(PhoneNumberUtil phoneUtil) {
        this(Locale.getDefault().getCountry(), phoneUtil);
    }
     ...
     */
    private PhoneNumberFormattingTextWatcher(String countryCode, PhoneNumberUtil phoneUtil) {
